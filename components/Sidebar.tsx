...
const Sidebar = () => {
    return (
        <div>
            ...
            <p className="px-2 py-1 my-3 bg-gray-200 rounded-full">Web Enthusiast</p>
            ...
            <button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-blue-400 to-green focus:outline-none"> Theme</button>
